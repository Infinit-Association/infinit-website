        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-[#E60000]/15 rounded-xl flex items-center justify-center shrink-0">
                <Target size={24} className="text-[#E60000]" />
              </div>
              <h2 className="font-[family-name:var(--font-inter)] font-extrabold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-[#E60000] to-[#FFD700]">Our Mission</h2>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="font-[family-name:var(--font-inter)] font-extrabold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-[#FFD700] to-[#E60000]">Our Vision</h2>
            </div>
